const keys = { companies: "jk-companies", documents: "jk-documents", users: "jk-auth-users", messages: "jk-inbox-messages", session: "jk-auth-session" };
...
export const storage = {
  ...
  messages(fallback = []) { return read(keys.messages, fallback); },
  saveMessages(value) { write(keys.messages, value); },
