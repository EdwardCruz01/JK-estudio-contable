(function () {
  ...
  const pageBanner = (className, eyebrow, title, copy, image, alt) => `<section class="corporate-banner ${className}" aria-label="${eyebrow}"><img src="/assets/contenido/${image}" alt="${alt}" /><div class="corporate-banner-copy"><span class="public-eyebrow">${eyebrow}</span><h1>${title}</h1><p>${copy}</p></div></section>`;
  ...
  function team() { return `<main class="public-page public-page-team">
    <section class="corporate-section founder-section page-hero page-hero-team"><div class="founder-image page-hero-media"><img src="/assets/contenido/founder-jimm.png" alt="CPC. Jimm Kenny Nolasco Cotrina" /><span>CONTADOR A CARGO</span></div><div class="page-hero-copy"><span class="public-eyebrow">NUESTRO EQUIPO</span><h1>Profesionales que entienden su negocio</h1><h3>CPC. Jimm Kenny Nolasco Cotrina · Contador a cargo</h3><p>Con más de 15 años de experiencia, acompaña a empresas con una visión técnica, cercana y enfocada en decisiones financieras mejor informadas.</p><p>Su enfoque combina precisión contable, prevención de riesgos tributarios y orden en cada proceso de gestión.</p></div></section>
    <section class="corporate-section"><div class="section-heading centered"><span class="public-eyebrow">ESPECIALISTAS</span><h2>Conocimiento que se complementa.</h2></div><div class="people-grid"><article><img src="/assets/contenido/team-maria.png" alt="María Álvarez" /><h3>María Álvarez</h3><span>GERENTE CONTABLE</span><p>NIIF · Estados Financieros · Control de gestión</p></article><article><img src="/assets/contenido/team-jorge.png" alt="Jorge Rivera" /><h3>Jorge Rivera</h3><span>ASESOR TRIBUTARIO</span><p>PDT · Fiscalizaciones · SUNAT</p></article><article><img src="/assets/contenido/team-carla.png" alt="Carla Mendoza" /><h3>Carla Mendoza</h3><span>CONSULTORA LABORAL</span><p>Planillas · Recursos Humanos · Relaciones laborales</p></article></div></section>
  </main>`; }
