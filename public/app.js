...
function render() { root.innerHTML = state.mode === "public" ? corporatePublicView() : state.mode === "auth" ? authView() : state.mode === "client" ? clientView() : adminView(); bind(); }
